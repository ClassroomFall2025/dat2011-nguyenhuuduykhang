...
def tinh_tien_nuoc(so_nuoc):
    gia_ban_nuoc= (7500, 8800, 12000, 24000) 
    if so_nuoc <= 10:
        return so_nuoc * gia_ban_nuoc[0]
    elif so_nuoc <= 20:
        return 10 * gia_ban_nuoc[0] + (so_nuoc - 10) * gia_ban_nuoc[1]
    elif so_nuoc <= 30:
        return 10 * gia_ban_nuoc[0] + 10 * gia_ban_nuoc[1] + (so_nuoc - 20) * gia_ban_nuoc[2]
    else:
        return 10 * gia_ban_nuoc[0] + 10 * gia_ban_nuoc[1] + 10 * gia_ban_nuoc[2] + (so_nuoc - 30) * gia_ban_nuoc[3]
